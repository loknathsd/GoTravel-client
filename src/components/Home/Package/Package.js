...
const Package = ({pk}) => {
    ...
    return (
        <div className='col-lg-4 col-md-6 my-3'>
            <div style={{height:'550px',width:'350px'}}  className="card text-center">
                <div style={{fontFamily:'poppins'}} className="card-body">
                    <img className='img-fluid' src={image} alt="" />
                    <h2 className='my-3'>{name}</h2>
                    <p style={{fontSize:'18px',height:'100px',overflow:'hidden'}}  className='text-secondary text-left'>{des}</p>
